...
class DeepCopy_CircularNext implements Runnable {
    ...
    public void run() {
        ...
        current = copy.head;
        for (int i=0; i<copy.numOfCards; i++) {
            System.out.print(current + " ");
            current = current.next;
        }
        System.out.println(" ");
...
class Encode_54Cards implements Runnable{
    @Override
    public void run() {
        Deck deck = new Deck();
        // all 54 cards
        ...
        SolitaireCipher encoder = new SolitaireCipher(deck);
        System.out.println("String to be encoded is: Hello My Name is Jin");
        String encoded = encoder.encode("Hello My Name is Jin");
        System.out.println("Encoded string: " + encoded);
        SolitaireCipher decoder = new SolitaireCipher(deck);
...
public class Minitester_Updated3 {
